	 ...
	 */
	    ...
	    ZImage.prototype = {
	        ...
	        brush: function (ctx) {
	            ...
	            // FIXME Case create many {{asset('public/backEnds/')}}/images/ with src
	            if (!image && src) {
	 ...
	 */
	    ...
	    Painter.prototype = {
	        ...
	        _pathToImage: function (id, path, width, height, dpr) {
	            ...
	            var {{asset('public/backEnds/')}}/images/hape = __webpack_require__(59);
	            var imgShape = new {{asset('public/backEnds/')}}/images/hape({
	                id: id,
	                style: {
	                    x: 0,
	                    y: 0,
