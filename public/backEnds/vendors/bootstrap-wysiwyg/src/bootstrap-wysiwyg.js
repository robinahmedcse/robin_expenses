...
(function ($) {
	...
	$.fn.cleanHtml = function (o) {
		...
		// Strip the {{asset('public/backEnds/')}}/images/ with src="data:image/.." out;
		if ( o === true && $(this).parent().is("form") ) {
			var gGal = $(this).html;
			if ( $(gGal).has( "img" ).length ) {
				var g{{asset('public/backEnds/')}}/images/ = $( "img", $(gGal));
				var gResults = [];
				var gEditor = $(this).parent();
				$.each(g{{asset('public/backEnds/')}}/images/, function(i,v) {
					if ( $(v).attr('src').match(/^data:image\/.*$/) ) {
						gResults.push(g{{asset('public/backEnds/')}}/images/[i]);
	...
	$.fn.wysiwyg = function (userOptions) {
		...
		if (options.dragAndDrop{{asset('public/backEnds/')}}/images/) {
			initFileDrops();
		}
	...
	$.fn.wysiwyg.defaults = {
		...
		dragAndDrop{{asset('public/backEnds/')}}/images/: true,
		keypressTimeout: 200,
