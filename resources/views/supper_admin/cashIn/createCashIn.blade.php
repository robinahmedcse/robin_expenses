...
@section('title','Add cash In info')
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cash In <small>Add from</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <br />
                     ...
                     {!! Form::open(['url'=>'/dashboard/cash/in/save','method'=>'POST','class'=>'form-horizontal form-label-left']) !!}    
                        <!-- Category name -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="t_name" name="cash_in_amount" value="{{ old('cash_in_amount')}}" required
